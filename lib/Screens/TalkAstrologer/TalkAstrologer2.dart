...
class TalkAstrologer2 extends StatefulWidget {
  final chatKey;
  final talkKey;
  final videoKey;
  final appBarName;
  ...
  @override
  _TalkAstrologer2State createState() => _TalkAstrologer2State();
}

class _TalkAstrologer2State extends State<TalkAstrologer2> {
  ...
  void getAstrologerApi(
      {required String catId, var gender, var language, var sort}) async {
