...
class FemalePlanetDetail {
    ...
    FemalePlanetDetail({this.fullDegree, this.house, this.id, this.isRetro, this.is_planet_set, this.nakshatra, this.nakshatraLord, this.nakshatra_pad, this.name, this.normDegree, this.planet_awastha, this.sign, this.signLord, this.speed});

    factory FemalePlanetDetail.fromJson(Map<String, dynamic> json) {
        return FemalePlanetDetail(
