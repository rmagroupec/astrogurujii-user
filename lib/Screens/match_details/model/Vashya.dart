...
class Vashya {
    ...
    Vashya({this.description, this.female_koot_attribute, this.male_koot_attribute, this.received_points, this.total_points});

    factory Vashya.fromJson(Map<String, dynamic> json) {
        return Vashya(
