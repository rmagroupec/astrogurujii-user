...
class Male {
    ...
    Male({this.is_mars_manglik_cancelled, this.is_present, this.manglik_present_rule, this.manglik_report, this.manglik_status, this.percentage_manglik_after_cancellation, this.percentage_manglik_present});
