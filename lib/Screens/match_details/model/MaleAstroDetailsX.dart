...
class MaleAstroDetailsX {
    ...
    MaleAstroDetailsX({this.ascendant, this.charan, this.gan, this.karan, this.nadi, this.naksahtra, this.naksahtraLord, this.name_alphabet, this.paya, this.sign, this.signLord, this.tatva, this.tithi, this.varna, this.vashya, this.yog, this.yoni, this.yunja});

    factory MaleAstroDetailsX.fromJson(Map<String, dynamic> json) {
        return MaleAstroDetailsX(
