...
class VashyaX {
    ...
    VashyaX({this.description, this.female_koot_attribute, this.male_koot_attribute, this.received_points, this.total_points});

    factory VashyaX.fromJson(Map<String, dynamic> json) {
        return VashyaX(
